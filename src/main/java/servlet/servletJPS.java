...
@WebServlet("/YattemiruJSP")
public class servletJPS extends HttpServlet {
...
//　ここまでは全く一緒
    ...
    //ここがJSPに投げるところ	
    		request.getRequestDispatcher("/WEB-INF/servletJSP.jsp").forward(request, response);
...
*/
 ...
 //JSP用の追加エリア       
     // 検索結果をリクエストスコープに保存
        ...
        request.setAttribute("searched", true); // 検索ボタンを押したかどうかのフラグ

        // 表示用JSPへ転送
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/servletJSP.jsp");
